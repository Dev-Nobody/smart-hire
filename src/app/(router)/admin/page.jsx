...
export default function Dashboard() {
  ...
  const fetchPendings = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/job-applications/pending`
      );
  ...
  const fetchShortListed = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/job-applications/shortlisted`
      );
  ...
  const fetchJobs = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/job-management/get-list`
      );
  ...
  const handleAddJob = async (values) => {
    try {
      ...
      await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/job-management/create`,
        {
          ...values,
  ...
  const fetchApplicants = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/job-applications/getApplicants`
      );
  ...
  const setJobToDeleteHandler = async () => {
    try {
      const response = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/job-management/delete-job/${jobToDelete.id}`
      );
